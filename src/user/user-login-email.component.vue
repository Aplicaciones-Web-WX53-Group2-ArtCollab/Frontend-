    ...
    <template #content>
      <div class="card flex justify-content-center">
        <div class="flex flex-column gap-1">
          ...
          <pv-inputtext class="text-sm" id="email" :placeholder="$t('login_email_placeholder_1')" />
          ...
          <div class="flex justify-content-center gap-2 mt-3">
            ...
            <pv-button class="w-full bg-white text-sm" :label="$t('login_email_button_2')" plain text/>
          </div>
        </div>
      </div>
    </template>
