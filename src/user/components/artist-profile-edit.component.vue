        ...
        <div class="portfolio" aria-label="Artist portfolio">
          ...
          <div class="flex-container">
            <div class="illustrations-container">
              <img :class="index === illustrations.length - 1 ? 'large-image' : 'normal-image'"
                   v-for="(illustration, index) in illustrations" :key="illustration.id" :src="illustration.imgUrl"
