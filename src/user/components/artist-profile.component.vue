  ...
  <div class="artist-profile ">
    <div class="banner">
      ...
      <div class="profile-image">
        <img src="https://github.com/Aplicaciones-Web-WX53-Group2-ArtCollab/Frontend-/blob/bounded-context/content/src/assets/images/artist-profile-image.png?raw=true" width="496" alt="Artist profile image">
    ...
    <div class="flexbox-container">
      <div class="flex-item">
        ...
        <div class="artist-books">
          ...
          <div class="flex-container-2">
            <img class="normal-image" src="https://github.com/Aplicaciones-Web-WX53-Group2-ArtCollab/Frontend-/blob/bounded-context/content/src/assets/images/hooky-cover.png?raw=true" alt="Book 2 image">
            <p>Hooky</p>
          </div>
        </div>
      </div>
      <div class="flex-item">
        ...
        <div class="portfolio">
          ...
          <div class="flex-container">
            ...
            <img class="large-image" src="https://github.com/Aplicaciones-Web-WX53-Group2-ArtCollab/Frontend-/blob/bounded-context/content/src/assets/images/portfolio-3.png?raw=true" alt="Portfolio first image">
          </div>
        </div>
      </div>
    </div>
