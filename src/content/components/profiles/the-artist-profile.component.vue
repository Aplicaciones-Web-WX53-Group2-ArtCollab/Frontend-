    ...
    <div class="flexbox-container">
      <div class="flex-item">
        ...
        <div class="artist-books">
          ...
          <div class="flex-container-2">
            <img class="normal-image" src="/src/assets/images/hooky-cover.png" alt="Book 2 image">
            <p>Hooky</p>
          </div>
        </div>
      </div>
      <div class="flex-item">
        ...
        <div class="portfolio">
          ...
          <div class="flex-container">
            ...
            <img class="large-image" src="/src/assets/images/portfolio-3.png" alt="Portfolio first image">
          </div>
        </div>
      </div>
    </div>
